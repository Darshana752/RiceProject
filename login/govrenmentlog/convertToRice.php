...
if (isset($_POST['submit'])){
  ...
  $departmentid = mysqli_real_escape_string($connection,$_POST['Did']);
  $stockid=mysqli_real_escape_string($connection,$_POST['Stid']);
  ...
  if ($result4 && mysqli_num_rows($result4) > 0) {
    ...
    $query3= "INSERT INTO ricestock (quantity, currentstock,did,dateofprocess) VALUES ($quantity, $updated_total,$departmentid,$dop)";
