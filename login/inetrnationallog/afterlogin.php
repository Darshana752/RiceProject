...
<html lang="en">
  <head>
    ...
    <style>
      ...
      body {
        ...
        background-size: 1600px auto; /* Width = 500px, height adjusts automatically */
  ...
  <body style="background-image: url('hh1.jpg')">
    ...
    <div style="text-align: center; color: darkgreen">
      <h1 style="margin-bottom: 0px; background-color: #6ffd6b">Farmer</h1>
    </div>
    <div class="card text-center">
      <div class="card-header">
        <ul class="nav nav-tabs card-header-tabs">
          ...
          <li class="nav-item">
            <a class="nav-link" aria-disabled="true" href="exportrice.html">Export Rice</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="contact.html">Contact</a>
          </li>
          <li class="nav-item">
            <a class="nav-link" href="helpintorganization.html">Help</a>
          </li>
        </ul>
      </div>
    </div>
